...
public class UnitSelectionBoxSinglePlayer : MonoBehaviour
{
    Camera myCam;
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            UnitSelectionManagerSinglePlayer.Instance.DeselectAll();
            SelectUnits();
            }
    ...
    void SelectUnits()
    {
        foreach (var unit in UnitSelectionManagerSinglePlayer.Instance.allUnitsList)
        {
            if (unit != null && unit.gameObject.activeInHierarchy)
            {
                ...
                {
                    UnitSelectionManagerSinglePlayer.Instance.DragSelect(unit);
                }
            }
        }
    }
