...
public class UnitSelectionManagerSampleScene : MonoBehaviour
{
    public static UnitSelectionManagerSampleScene Instance { get; set; }
   ...
   public void DeselectAll()
    ...
    {
        unit.GetComponent<UnitMovementSampleScene>().enabled = shouldMove;
    }
