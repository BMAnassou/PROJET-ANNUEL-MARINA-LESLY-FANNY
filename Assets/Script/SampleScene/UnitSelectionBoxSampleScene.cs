...
public class UnitSelectionBoxSampleScene : MonoBehaviour
{
    Camera myCam;
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            UnitSelectionManagerSampleScene.Instance.DeselectAll();
            SelectUnits();
            }
    ...
    void SelectUnits()
    {
        foreach (var unit in UnitSelectionManagerSampleScene.Instance.allUnitsList)
        {
            if (unit != null && unit.gameObject.activeInHierarchy)
            {
                ...
                {
                    UnitSelectionManagerSampleScene.Instance.DragSelect(unit);
                }
            }
        }
    }
